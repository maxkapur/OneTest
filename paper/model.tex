...
Finally, this article has favored the nonatomic formulation of the matching problem, and characterized equilibrium using fixed-point theorems and price dynamics. However, in the discrete context, stable matches can be characterized using lattice theory, and there is a distinct notion of a fixed-point that applies here \parencite[][]{coremanytoonebyfixedpoint}. It seems there are many promising directions of future theoretical inquiry into the characterization of nonatomic stable assignments. 

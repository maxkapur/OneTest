...
% Maybe this can be moved to below the next section, and then build in the discussion of incentives, speculate a bit about how the shape of the incentive gradient is similar. see diag of jacobians. 

...
First, I define admissions markets and offer some preliminary theoretical results on the notion of equilibrium. The notion of equilibrium affords several interpretations: It is a fixed point of a t\^{a}tonnement process in which schools adjust their cutoffs in pursuit of a target class size, it is a competitive equilibrium of a game in which schools compete for a desirable student body, and it is a stable matching like that computed by deferred acceptance algorithms.
...
The applicability and interpretation of the equilibrium conditions depends on the design of the admissions market. I offer three interpretations that reflect a variety of real-world market designs. With additional assumptions on $\eta$, such as full support, all three interpretations become sufficient conditions for equilibria as well. Additionally, the first interpretation establishes a sufficient condition for the existence of an equilibrium. 
...
The question of how to measure aggregate college preferability is not a simple one, and newspaper university rankings attract regular controversy for their imprecise methodology \parencite[][]{intlrankingsandconflicts}. Typically, such measures are based on a combination of survey data and performance measures of a university's quality, for example, its research output or data on alumni salaries. However, conducting accurate surveys is costly and difficult, and while performance measures may correlate with college preferability, they offer a normative indication of which colleges ``should'' be popular without accounting for the decisions students actually make---decisions that may depend less on hard facts than on intangible notions of fitness and gut feelings. The latter may seem beyond the purview of economic analysis, but college administrators often want to know in quantitative terms how preferable their school is from a marketing point of view. Yield has been the traditional measure in this area, and as discussed above, it is a useful tool in modeling each school's demand curve. However, for the purposes of comparing two different schools, it is useful to have a number that represents, given a graduating high school senior who is deciding among a subset of schools, the probability that she will pick $c$. True yield approximates this value, but it systematically overestimates the popularity of lenient schools, which face less competition for students. For example, consider a market with only two schools, Antarctic University and Oxvard University. Oxvard-tier students can choose between two schools, while Antarctic University--tier students have only one choice. Both schools may have similar true yield, but clearly Oxvard is globally preferable when controlling for selectivity. $\gamma$, on the other hand, is free of bias at the extreme ends of the distribution. To the extent that it can be estimated accurately, it is an objective measure of aggregate college preferability. 


\section{Discussion}
This article has considered nonatomic admissions markets, and attempted to link the mechanism-design paradigm that treats stable assignment as a normative goal with regression models that model colleges' demand in a decentralized context. Theoretically, this result is established by verbally interpreting prior results in mechanism design. 

with a notion of equilibrium that regards stable assignment
